				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift">添加</i>
							</div>
							
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="add_info" id="form" class="form-horizontal" method="post">
								<div class="form-body">
									...
									<div class="form-group last">
										...
										* </span>
										...
										<div class="col-md-9">
											<textarea class="ckeditor form-control" name="content" rows="6" data-error-container="#editor_error"></textarea>
											<div id="editor_error">
