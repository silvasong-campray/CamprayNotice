	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
					<div class="col-md-12">
						...
						<div class="portlet  box green">
							<div class="portlet-title">
								...
								<div class="actions">
								    <a class="btn btn-default btn-sm"  href="<c:url value="/"/>dashbord/add"><i class="fa fa-plus"></i>添加</a>
								    <a class="btn btn-default btn-sm"  id="edit"><i class="fa fa-plus"></i>编辑</a>
								    <a class="btn btn-default btn-sm" data-toggle="modal" href="#delete_info" id="delete"><i class="fa fa-trash-o"></i>删除</a>
								    <div class="btn-group">
										...
										<div id="column_toggler"
											...
											<label><input type="checkbox" checked data-column="1">Tilte</label>
											<label><input type="checkbox" checked data-column="2">Content</label>
											<label><input type="checkbox" checked data-column="3">CreateTime</label>
				...
				<div class="modal" id="delete_info" tabindex="-1" data-backdrop="static" data-keyboard="false">
